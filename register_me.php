...
<br />
     ...
     <h3> New? Register Here!</h3>
      ...
      &nbsp;
       ...
       <tr>
          <td><a data-toggle="modal" href="use_site.php" >Use of the Site</a></td>  
       </tr>
	...
	$conn->query("insert into members (image,firstname,lastname,middlename,sex,address,contact_no,date_of_birth,username,email,password,access,status,acct_status)
                          ...
                          ?>
                          	...
                          	<script>
						 alert('Your request has been submitted to the administrator. Please wait for the administrator to activate your account. Thank you.');
